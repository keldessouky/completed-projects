...
Metadata fingerprint: `sha256:f8e8db43aa3effd7ff3fb50401a2f9e95d39ed4c2a634e0c32b82cfa2cb621a6`
...
| Column | Planned type | Derived from |
| --- | --- | --- |
| `customer_id` | `string` | `sql, cast to string` |
| `full_name` | `string` | `sql, cast to string` |
| `region` | `string` | `sql, cast to string` |
| `segment` | `string` | `sql, cast to string` |
| `order_count` | `bigint` | `sql, cast to bigint` |
| `lifetime_spend` | `decimal(20,2)` | `sql, cast to decimal(20,2)` |
| `first_order_at` | `timestamp` | `sql, cast to timestamp` |
| `last_order_at` | `timestamp` | `sql, cast to timestamp` |
| `last_category` | `string` | `sql, cast to string` |
...
| `sql` | `inputs`, `outputs`, `query` | Run Spark SQL over the declared inputs, producing the declared columns. |

...
export type SfxName =
  | 'uiTap' | 'shoot' | 'gateGood' | 'gateBad' | 'squadGain' | 'squadLoss'
  | 'hitTick' | 'enemyDie' | 'bossHit' | 'shieldClang' | 'whoosh' | 'breach'
  | 'lamassuWake' | 'coin' | 'starPop' | 'upgrade' | 'winJingle' | 'failSting';
export type MusicName = 'musicTitle' | 'musicRun' | 'musicVictory';
